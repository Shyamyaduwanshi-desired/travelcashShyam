...
public class ActDonate extends AppCompatActivity implements View.OnClickListener, TransferMoneyFriend.Transfer {
...
//                showDialog("comming soon");
                finish();
                Animatoo.animateSlideRight(ActDonate.this);
            }
            else
    ...
    public void onBackPressed() {
        finish();
        Animatoo.animateFade(ActDonate.this);
    }
